...
const RoleAccess = () => {
  ...
  const [activeTab, setActiveTab] = useState("Modules"); // default selected tab
      ...
      <div className="UsersContent xl:max-w-[70%] p-[30px] grid gap-[10px]">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={tabButtonStyle("Controls")}
          >
            Controls
          </button>
        </div>

        {/* Show Table only for Modules tab */}
        {selectedRole && activeTab === "Modules" && (
