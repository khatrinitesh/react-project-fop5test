...
export const sidebarNavigation = [
...

  {
    ...
    children: [
      ...
      { label: "Product", icon: FaBox, path: "/new/product-tracking" },
      { label: "Meeting", icon: FaHandshake, path: "/new/meeting-search" },
...

  {
    ...
    icon: FaSearch,
    children: [
      { label: "Member", icon: FaUserAlt, path: "/search/members-search" },
      { label: "One Philly", icon: FaCity, path: "/search/one-philly-search" },
      {
        label: "Matter",
        icon: FaBriefcase,
        path: "/search/legal-matters-search-2",
      },
      { label: "Task", icon: FaTasks, path: "/search/task-search" },
      { label: "Product", icon: FaBox, path: "/search/product-search" },
      { label: "Meeting", icon: FaHandshake, path: "/search/meeting-search" },
      {
        label: "Interview",
        icon: FaMicrophone,
